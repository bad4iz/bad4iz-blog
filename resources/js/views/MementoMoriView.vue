...
export default {
    ...
    data: () => ({
        ...
        quotes: [
            {
                author: 'синека',
                text: 'Дело не в том что нам мало отведено времени, а в том что мы тратим его в пустую.',
            },
        ],
    }),
    computed: {
    ...
    methods: {
        ...
        async getQuotes() {
            const res = await window.axios.get('/api/get-github-file/journal/quotesMementoMori.json');
